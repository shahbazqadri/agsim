...
class custom_trajectory(object):
    ...
    def plan_cartesian_path(self, scale=1):
        ...
        while wpose.position.x < 3:
            wpose.position.x += 0.1*scale
            wpose.position.y = sin(wpose.position.x)
    ...
    def dispaly_trajectory(self,plan):
        robot = self.robot
...
def main():
        try:
            ...
            raw_input()
            trajectory.go_to_joint_state()

            print "Press Enter to display cartesian path"
            raw_input()
            cartesian_plan,fraction = trajectory.plan_cartesian_path()

            print "Press Enter to display saved trajectory"
            raw_input()
            trajectory.dispaly_trajectory(cartesian_plan)

            print "Press Enter to execute saved trajectory"
            raw_input()
            trajectory.execute_plan(cartesian_plan)
